...
export async function POST(req: Request) {
  ...
  await db
    ...
    .values({
      ...
      githubId: userInfo.githubUserId,
    })
    .execute();
...
function getUserInfo(payload: Payload) {
  ...
  const userInfo = {
    ...
    githubUserId: externalAccountData.provider_user_id,
    githubUsername: externalAccountData.username,
    avatarUrl: externalAccountData.avatar_url,
  };
